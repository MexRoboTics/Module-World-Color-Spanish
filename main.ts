...
namespace Module_World_Color {
    ...
    export enum enGetRGB {
        //% blockId="GetValueR" block="ObtenerValorR"
        GetValueR = 0,
        //% blockId="GetValueG" block="ObtenerValorG"
        GetValueG = 1,
        //% blockId="GetValueB" block="ObtenerValorB"
        GetValueB = 2
    }
    ...
    //% blockId=ModuleWorld_Sensor_GetRGBValue block="ObtenerValorRGB|valor %value"
    //% blockGap=20
    //% weight=98
    //% color="#0000cd"
